...
\newcommand{\calculatrice}{\includegraphics[width=13pt]{icons/calc.png}}
\newcommand{\nocalculatrice}{\includegraphics[width=13pt]{icons/nocalc.png}}
\newcommand{\I}{\noindent}
...
\renewcommand{\P}{\mathbb{P}} % probabilité
...
% \newcommand{\vect}[2]{\left(\begin{array}{c}#1\\#2\end{array}\right)} %vecteur du plan
\newcommand{\coordvp}[2]{\begin{pmatrix}#1\\#2\end{pmatrix}} %vecteur du plan idem
...
\newcommand{\demonstration}{\includegraphics[width=12pt]{icons/demo.png}}
...
\newcommand{\addfootnotes}{
	\footnotetext[1]{Exercice pour aller plus loin, corrigé au verso}
	\footnotetext[2]{Exercice d'entraînement, corrigé dans le livre}
	\footnotetext[3]{Exercice avec partie algorithmique}
}
\newcommand{\diff}{($\ast$)}
\newcommand{\train}{($\dag$)}
\newcommand{\alg}{($\ddag$)}