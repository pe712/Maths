...
\medskip
\noindent Dans un repère $\oij$, la courbe représentative de la fonction carré est une \textbf{parabole} de sommet $O$.
...
\begin{deme}{}{}
Proposition à démontrer : \og La fonction carrée est strictement décroissante sur $\of{-\infty}{0}$ et strictement croissante sur $\fo{0}{+\infty}$. \fg{} 
...
%\item Démontrons maintenant que la fonction carrée est strictement décroissante sur $\of{-\infty}{0}$
...
%&\Longrightarrow \quad (a)^2 > b \times a > (b)^2 \quad \Longrightarrow \quad (a)^2 > (b)^2 \quad \Longrightarrow \quad f(a) > f(b)
%\end{align*} 
%Donc la fonction $f$ est strictement décroissante sur $\of{-\infty}{0}$\hfill $\blacksquare$
\item  On procède de même pour montrer que la fonction carrée est strictement décroissante sur $\of{-\infty}{0}$ \hfill $\blacksquare$
\end{itemize}
\end{deme}
...
\medskip
\noindent Dans un repère $\oij$ la courbe représentative de la fonction inverse est une \textbf{hyperbole} de centre $O$.
...
\medskip
\begin{itemize}
\item Commençons par démontrer que la fonction inverse est strictement décroissante sur $\of{0}{+\infty}$:
...
\item Démontrons maintenant que la fonction inverse est strictement décroissante sur $\of{-\infty}{0}$:
...
\begin{defi}{}{}
La fonction définie sur $\R^+ = \fo{0}{+\infty}$ par  $f: x \longmapsto \sqrt{x}$ est appelée fonction \textbf{racine carrée}
\end{defi}
...
\begin{deme}{}{}
Proposition à démontrer : \og La fonction racine carrée est strictement croissante sur $\fo{0}{+\infty}$ \fg{} 
...
\begin{methode}{}{}[Comment montrer qu'une fonction est paire]
\begin{itemize}
...
\begin{methode}{}{}[Comment montrer qu'une fonction est impaire]
\begin{itemize}
\item Il peut s'avérer utile de tracer la courbe représentative de $f$ à la calculatrice.
