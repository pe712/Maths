...
\begin{prop}{}{}
Toute droite du plan de vecteur directeur $\v{u} \coordvp{-b}{a}$ à pour équation cartésienne : \[\quad \quad \quad ax+by+c=0 \quad \text{ avec $a$, $b$, $c \in \R$ et $a$ ou $b$ non nul}\]
\end{prop}

\begin{deme}{}{}
Proposition à démontrer : \og Toute droite du plan de vecteur directeur $\v{u} \coordvp{-b}{a}$à pour équation cartésienne $ax+by+c=0 \text{ avec $a$, $b$, $c \in \R$ et $a$ ou $b$ non nul}$ 

\medskip
\noindent On considère la droite $(AB)$ de vecteur directeur $\v{AB} \coordvp{-b}{a}$
...
\medskip
\hspace{30mm}$\v{AM}\coordvp{x-x_A}{y-y_A}$ \hspace{20mm} et \hspace{20mm} $\v{AB}\coordvp{-b}{a}$
...
\medskip
\noindent La droite $(AB)$ de vecteur directeur $\v{AB} \coordvp{-b}{a}$ a pour équation cartésienne : $ax + by + c = 0$\hfill $\blacksquare$
\end{deme}
...
\begin{methode}{}{}[A partir de $m$ et $p$]
...
\noindent \begin{minipage}{8cm}
\begin{methode}{}{}[Calcul de coordonnées de points appartenant à la droite]

\medskip
\begin{itemize}
\item Choisir deux valeurs de $x$ : $x_{1}$ et $x_{2}$,\medskip
\item Calculer $y_{1}$ et $y_{2}$,\medskip
\item Placer les points $A(x_1;y_1 )$ et $B(x_2;y_2)$ dans le plan muni d'un repère $\oij$ \medskip
...
\hspace{5mm}
\noindent \begin{minipage}{8cm}
\begin{methode}{}{}[Utilisation du coefficient directeur et de l'ordonnée à l'origine]

\medskip
\begin{itemize}
\item Dans un repère $\oij$, placer le point $P$ de coordonnées $P(0;p)$,\medskip
