...
\begin{defi}{Nombre réel}{}
	...
	\draw[thick] (0.5, 0.1) -- (0.5, -0.1) node [below] {$\frac{1}{2}$};
...
\begin{notation}{}{}
	Pour dire qu'un élément $x$ appartient à un ensemble on utilise le symbole $\in$.

	Pour désigner un ensemble privé de zéro on utilise une astérisque $*$.
\end{notation}

\begin{ex}{}{}
	$n\in\N$ signifie \guillemotleft n appartient à $\N$ \guillemotright\ ou encore \guillemotleft n est un entier\guillemotright.

	$x\in\R^*$ signifie \guillemotleft x appartient à $\R$ privé de zéro \guillemotright\ ou encore \guillemotleft x est un réel non nul\guillemotright.
\end{ex}
...
\begin{rem}{}{}
	La lettre $\Q$ provient de l'italien \guillemotleft quoziente \guillemotright.	
\end{rem}
...
On fera attention aux règles de calcul concernant les fractions:
...
\begin{prop}{(Rappel) Priorité de calcul}{}
...
\begin{props}{}{}
	\begin{itemize}
		...
		\item La somme de deux rationnels et un rationnel.
	\end{itemize}
\end{props}
...
\begin{dem}{}{}
	...
	Soit $x\in\Q$, c'est-à-dire \guillemotleft $x$ est un rationnel\guillemotright.

	Par définition, il existe une fraction $\frac{a}{b}$ avec $a\in\Z$ et $b\in\N$ telle que $x=\frac{a}{b}$.
	
	On veut montrer que $\frac{1}{x}\in\Q$. Or $\frac{1}{x} = \frac{b}{a}$. Donc $\frac{1}{x}$ s'écrit comme une fraction.
...
\begin{props}{}{}
	...
	\begin{center}
		\begin{itemize}
			\item $\sqrt{2}$ n'est pas rationnel. On dit qu'il est irrationnel.
...
\begin{rems}{}{}
	\begin{itemize}
		...
		\item Attention, toutes les racines ne sont pas irrationnelles. Par exemple, $\sqrt{36}=6\in\Q$. On a même $\sqrt{36}\in\N$.
	\end{itemize}
\end{rems}
...
\begin{dem}{}{}
	...
	Nous allons le montrer sur un exemple. Soit $x\in\D$. Par exemple, $x = 454.5648$. Alors $x=\frac{4545648}{10000}$. Donc $x\in\Q$.

	On ferait tous les cas de façon similaire en multipliant par 10 au numérateur et au dénominateur autant de fois qu'il est nécessaire.
\end{dem}
...
\begin{notation}{}{}
	Lorsque l'écriture décimale a une infinité de chiffres qui se répète, on dit que le développement décimal est \textbf{périodique}. On utilise une barre au dessus de la séquence qui se répète pour le noter.
\end{notation}
...
\begin{rem}{}{}
	Pour un nombre rationnel $x=\frac{a}{b}\in\Q$, il y a deux possibilités:
	\begin{itemize}
		\item Soit $x\in\D$, et son développement décimal est fini. 
		\item Soit $x\notin\D$. Alors son développement décimal est infini et périodique ! En effet, lorsqu'on effectue la division de $a$ par $b$, il y a un nombre fini de restes possibles. Dès que l'on tombe sur un reste qu'on a déjà vu, alors les divisions suivantes seront identiques au motif déjà vu. 
	\end{itemize}
\end{rem}
...
\begin{bookexos}37,38,39 p.100\end{bookexos}


\sectionexo{Nombres rationnels, décimaux}
\begin{bookexos}{35, 36, 38 p.65}\end{bookexos}
\begin{bookexo}{120 p.69}\end{bookexo}

\sectionexo{Approximation décimale}
\begin{bookexo}{114 p.69}\end{bookexo}
\begin{bookexos}{115, 116 p.69}\end{bookexos}
