...
\begin{histoire}{}{}
	Dès l'Antiquité égyptienne ou babylonienne, les scribes disposaient de procédures pour trouver une quantité inconnue soumise à certaines conditions. Ainsi, les anciens Babyloniens et Égyptiens savaient déjà résoudre des problèmes qui peuvent être traduits en équations du premier ou second degré. Par exemple, ils savaient faire des règle de trois, c'est-à-dire des produits en croix.

	La civilisation grecque développe la géométrie à un niveau inégalé. Au IIIe siècle av. J.-C, Euclide produit un traité, très rigoureux pour l'époque, nommé \textit{les Éléments}.

	A priori ce sont deux domaines disctincts. D'une part, la géométrie s'intéresse à des figures, des points, des droites\dots D'autre part, l'algèbre s'intresse à des nombres, à des fractions, à des inconnues $x$\dots

  La physique est le moteur de l'unification de la géométrie et de l'algèbre. En 1604, Galileo Galilei établit la loi de la chute des corps. Les illustrations de ses notes montrent l'utilisation d'un repère. L'optique est la branche qui aboutit au progrès le plus marquant. Pierre de Fermat et René Descartes arrivent à la conclusion qu'un repère est une méthode systématique permettant d'appréhender tous les problèmes de géométrie euclidienne.
\end{histoire}
...
\begin{dem}{}{}
	Si I est le milieu du segment $[AB]$, alors $AI=IB$. Donc on a une égalité de normes $\norm{\vec{AI} }= \norm{\vec{IB}}$. De plus les points A, B et I sont alignés. Donc on a une égalité de direction entre $\vec{AI}$ et $\vec{IB}$. On a donc $\vec{AI}=\pm\vec{IB}$. Si on suppose par l'absurde que $\vec{AI}=-\vec{IB}$, alors $\vec{AI}=\vec{BI}$ et les points A et B sont confondus. Ce qui est une contradiction. Donc $\vec{AI}=\vec{IB}$.

	\smallskip
	\textbf{Réciproquement}, si $\vec{AI} = \vec{IB}$, alors leurs normes sont égales $\norm{\vec{AI} }= \norm{\vec{IB}}$. Donc $AI=IB$ et I se situe sur la médiatrice du segment $[AB]$.
...
\begin{dem}{}{}
	...
	Montrons la première égalité. On veut décomposer tous les vecteurs en fonction de deux vecteurs choisis au préalable, qu'on appellera une \textbf{base}. Choisissons par exemple $\vec{AB}$ et $\vec{BC}$.

	\smallskip
	D'une part, en utilisant Chasles, $\vec{AJ} = \vec{AB}+\vec{BJ}$.

	Puisque $J$ est le milieu de $[BC]$, $\vec{BJ} = \frac{1}{2}\vec{BC}$.

	Donc, \begin{align*}
		\frac{2}{3}\vec{AJ}= \frac{2}{3}(\vec{AB}+\frac{1}{2}\vec{BC})= \frac{2}{3}\vec{AB}+\frac{1}{3}\vec{BC}
	\end{align*}

	\smallskip
	D'autre part, en utilisant Chasles, $\vec{BK} = \vec{BA}+\vec{AK}$.

	Puisque $K$ est le milieu de $[AC]$, $\vec{AK} = \frac{1}{2}\vec{AC}$.

	Avec Chasles de nouveau, $\vec{AC} = \vec{AB}+\vec{BC}$.

	Donc, \begin{align*}
		\vec{AB}+\frac{2}{3}\vec{BK}
		&= \vec{AB}+\frac{2}{3}(\vec{BA}+\frac{1}{2}(\vec{AB}+\vec{BC}))\\
		&= \vec{AB}+\frac{2}{3}(-\vec{AB}+\frac{1}{2}\vec{AB}+\frac{1}{2}\vec{BC})\\
		&= \vec{AB}+\frac{2}{3}(-\frac{1}{2}\vec{AB}+\frac{1}{2}\vec{BC})\\
		&= \vec{AB}-\frac{1}{3}\vec{AB}+\frac{1}{3}\vec{BC}\\
		&= \frac{2}{3}\vec{AB}+\frac{1}{3}\vec{BC}
	\end{align*}

	\smallskip
	On a bien montré l'égalité voulue.
\end{dem}

\newpage

\section*{Exercices (Bordas 2019)}
\addfootnotes

\sectionexo{Translation}
\begin{bookexo}{48 p.137}\end{bookexo}
\begin{bookexo}{52 p.137}\end{bookexo}
\begin{bookexo}{54 p.137}\end{bookexo}
\begin{bookexo}{59 p.138}\end{bookexo}

\sectionexo{Opérations sur les vecteurs}
\begin{bookexo}{63 p.138}\end{bookexo}
\begin{bookexos}{72,73,76 p.139}\end{bookexos}
\begin{bookexo}{75 p.139 \train}\end{bookexo}


\sectionexo{Chasles}
\begin{bookexos}{67,68 p.138-139}\end{bookexos}
\begin{bookexo}{79 p.139}\end{bookexo}

\sectionexo{Milieu}
\begin{bookexo}{56 p.137}\end{bookexo}
\begin{bookexo}{78 p.139}\end{bookexo}

\sectionexo{Parcours d'approfondissement}
\begin{exo}{Démontrer que les médianes sont concourantes}\end{exo}
